...
* Decided to axe window minimization and just either have the window show or not show, so it tracks time even while the application is off, so you can restart, etc.
