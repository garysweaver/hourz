...
{Hourz}[http://garysweaver.github.com/hourz] is a Mac OS X application written in {HotCocoa}[http://www.macruby.org/hotcocoa.html]/{MacRuby}[http://www.macruby.org/] as a standalone app that can track time spent on various tasks via task timers.
...
The following are known issues. I'd put this in the {issue tracker}[http://github.com/garysweaver/hourz/issues], but this is easier for now.
...
* Persistence to file is not working. It corrupts task names and you lose the amount of time you spent on tasks.
